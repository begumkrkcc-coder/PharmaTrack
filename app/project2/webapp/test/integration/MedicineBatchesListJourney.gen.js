...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("MedicineBatchesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheMedicineBatchesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheMedicineBatchesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheMedicineBatchesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheMedicineBatchesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheMedicineBatchesListGenerated.onTable().iPressRow(0);
            Then.onTheMedicineBatchesObjectPageGenerated.iSeeThisPage();
