...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("MedicinesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheMedicinesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheMedicinesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheMedicinesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheMedicinesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheMedicinesListGenerated.onTable().iPressRow(0);
            Then.onTheMedicinesObjectPageGenerated.iSeeThisPage();
